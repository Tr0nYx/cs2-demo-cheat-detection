...
final class Version20260517000000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE trace_rating (
            ...
            calibration_version VARCHAR(50) DEFAULT \'default-v1\' NOT NULL,
        ...
        $this->addSql('CREATE UNIQUE INDEX IF NOT EXISTS idx_trace_rating_analysis_result_id ON trace_rating(analysis_result_id)');
