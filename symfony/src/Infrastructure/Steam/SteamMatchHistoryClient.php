    ...
    public function getNextCode(string $steamId, string $steamIdKey, string $knownCode): SteamMatchHistoryResult
    {
        try {
            ...
            return match ($response->getStatusCode()) {
                ...
                429 => SteamMatchHistoryResult::rateLimited(),
                503 => SteamMatchHistoryResult::steamUnavailable('steam_unavailable'),
                default => $response->getStatusCode() >= 500
                    ? SteamMatchHistoryResult::steamUnavailable('steam_server_error')
